...
test["ami setup (app)"] = function ()
    ...
    test.assert(not fs.exists"__test/assets" and not fs.exists"data/test/test.file" and
    not fs.exists"data/test2/test.file")
    os.chdir(default_cwd)
    test.assert(not error_called)
end
...
test["ami info"] = function ()
    ...
    expect_output(function ()
        ...
        test.assert(output:match"success" and output:match"test.app" and output:match"ok")
    end)
    os.chdir(default_cwd)
    test.assert(not error_called)
end
...
test["ami about"] = function ()
    ...
    expect_output(function ()
        ...
        test.assert(output:match"Test app" and output:match"dummy%.web")
    end)
    os.chdir(default_cwd)
    test.assert(not error_called)
end
...
test["ami unpack ..."] = function ()
    ...
    expect_output(function ()
        ...
        test.assert(output:match"internal unpack reached")
    end)
